...
\begin{itemize}
    \item Simulações computacionais levam um longo tempo para serem executadas % mesmo em PAD
...
\note[item]{Gerência de conteúdo científico $\leftarrow$ arquivos científicos}
\end{frame}
...
\begin{itemize}
    \item Consultas em SQL geradas automaticamente
    \item Junções ``automáticas'' baseadas no rastreio de dados de proveniência
